...
# define paths to save results (hadoop for intermediate datasets)
...
for i_ns in range(n_s):
    anchors_suppBroadcast =  spark.sparkContext.broadcast({anchor:1 for anchor in anchors_list[i_ns*smax:(i_ns+1)*smax]})
